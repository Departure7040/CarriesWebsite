...
## Addendum (2026-07-11, fourth pass — secondary directories)

A third-party AI sweep claimed several additional profiles. Per standing practice after that sweep's earlier "no GBP exists" hallucination (see Errata above), every claim was independently re-verified via live fetch before being recorded — nothing below is taken on the sweep's word alone. Full field-level detail is in `data/public_assets.yaml` and `data/source_log.csv`; claim-level status is in `data/known_claims.yaml`.

**1. HomeLight — CONFIRMED to exist.** Carrie appears in HomeLight's Iberia County and New Iberia, LA agent-directory pages, shown with a trailing asterisk and no photo — a pattern consistent with an unclaimed/system-generated listing rather than an agent-managed profile. No dedicated claimed-profile URL was isolated in this pass. The listing shows **9 years of experience**, which is a *third* data point in the years-experience conflict already flagged in this report: Zillow shows 11 years, HomeLight shows 9, and her eXp Facebook tenure is shown since Feb 2022 (~4yr4mo). Still `[client-confirm]`.

**2. RateMyAgent — CONFIRMED to exist, 0 reviews CONFIRMED true.** Her direct profile (`ratemyagent.com/real-estate-agent/carrie-billeaud-b0zzvd/sales/overview`) was located via a live, successfully-fetched area page that displays her inline: "star N/A — From 0 reviews overall." The direct profile URL itself returned HTTP 403 (JS/adblock wall) on scrape, but the review count is corroborated by the working page, so it's recorded as confirmed rather than snippet-only. One nuance worth keeping: the platform does appear to sync her transaction/listing data independent of reviews — she shows up as listing or co-listing agent (e.g., co-listed with Blake Arceneaux) on live RateMyAgent property pages with real MLS data. So "0 reviews" is true, but it does not mean the platform has no data on her — worth distinguishing when this comes up in conversation with Carrie.

**3. Acadian Home Builders Association (AHBA) member listing — CONFIRMED to exist; the "404" part of the claim is FALSE.** `business.acadianhba.com/list/Details/carrie-billeaud-4640468` loaded successfully (HTTP 200, full content, last modified 2026-06-19) — this directly contradicts the sweep's claim that the member link 404s. She's listed as an **Affiliate** member, category "Real Estate Sales & Marketing," with her usual bio (3x Icon Agent, RAA member, certified mentor) and a **new address variant**: 100 Goodwood Circle, Lafayette, LA 70508 — add this to the running NAP-conflict list. Phone matches primary.

   **This is a distinct entity from "Acadiana Home Builders" (the builder company, `acadianahomebuilders.com`, run by Moe & Missi Keeton)** — worth being precise about the difference when discussing this with Carrie. The AHBA membership above is a general trade-association credential. Separately, and more directly relevant: **`acadianahomebuilders.com`'s own homepage states, "We're very happy to have Carrie Billeaud representing Acadiana Home Builders as our realtor,"** listing her name/phone/email as their realtor contact, and their Instagram (2,298 followers) repeatedly credits her on new-construction listing posts (e.g., 204/206 Ivy Cottage, Le Jardin, Youngsville). **This independently corroborates — from the builder's own site, not just Carrie's side — what she told Brook directly on 2026-07-11: that she's partnering with Acadiana Home Builders.** It also matches the "Proud Partner with Acadiana Home Builders" line already seen in the Facebook business-page bio during the 2026-07-08 audit. Together, the AHBA trade-association membership and the specific builder partnership form a consistent, mutually-reinforcing picture — she's both a credentialed participant in the local homebuilding trade community and the named realtor for one active builder within it.

**4. Other directories checked (task scope, "if quick"):** **UpNest** — found a genuine, not-previously-tracked profile (`upnest.com/re/top-real-estate-agents/la/lafayette`): "Carrie Billeaud, eXp, 0 Sold in the last year, 11 years Experience" — the 11-years figure matches Zillow, adding to (not resolving) the years-experience conflict. **1 Percent Lists** and **Rocket Homes** — checked, no evidence of a real Carrie Billeaud profile on either (not exhaustive searches).

**The core presence-gap insight this pass surfaces:** Carrie's **185 Google reviews at 5.0★ are not syndicating anywhere else.** Zillow (29), Realtor.com (2), Homes.com (0), and now RateMyAgent (0) all show a small fraction — or none — of the review volume her GBP has actually earned. This isn't a "she needs more reviews" problem — she already has 185 of them — it's a **distribution** problem: the reviews exist in one place and aren't being requested/synced/showcased anywhere else that a prospective client might land first. This is arguably the single highest-leverage, lowest-effort fix available: request-syndication tools (or simply asking recent clients to also drop a review on Zillow/Realtor.com) could close this gap without generating a single new review.

---

**Report Generated:** 2026-07-08 (corrected 2026-07-08; addendum added 2026-07-08 second pass; addendum added 2026-07-08 third pass; addendum added 2026-07-11 fourth pass)
